...
const aboutData = [
  ...
  },
  {
    ...
    info: [
      {
        title: 'UX/UI Designer - UPWORK',
        stage: '2023',
      },
      {
        title: 'Web Developer - IILM UNIVERSITY',
        stage: '2023 - 2024',
      },
      {
        title: 'Intern - BTC Company',
        stage: '2023 ',
      },
    ],
  },
  {
    ...
    info: [
      {
        title: 'Web Development - IILM UNIVERSITY',
        stage: '2024',
      },
      {
        title: 'Computer Science engineering - IILM UNIVERSITY',
        stage: '2023',
      },
      {
        title: 'Certified Graphic Designer - upwork.com',
        stage: '2022',
      },
    ],
  },
      ...
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
        ...
        <div className='flex-1 flex flex-col justify-center'>
             <motion.h2 variants={fadeIn('right', 0.2)} initial="hidden" animate="show" exit="hidden"  className='h2'>
              Captivating <span className='text-accent'>stories</span>birth magnification designs.
              </motion.h2>
             <motion.p variants={fadeIn('right', 0.4)} initial="hidden" animate="show" exit="hidden"  className='max-w-[500px] mx-auto xl:mx-0 mb-6 xl:mb-12 px-2 xl:px-0 '>10 years, I began freelancing as a developer. Since then, I've done remote work for agencies, counsulted for startups, and collaborated on digital products for business and consumer use.</motion.p>
             {/* counters */}
              ...
              <div className='flex flex-1 xl:gap-x-6'>
                ...
                <div className='relative flex-1 after:w-[1px] after:h-full after:bg-white/10 after:absolute after:top-0 after:right-0' >
                  <div className='text-2xl xl:text-4xl font-extrabold text-accent mb-2  '>
                     <CountUp strat={0} end={10} duration={5} /> +
                  </div>
                ...
                <div className='relative flex-1 after:w-[1px] after:h-full after:bg-white/10 after:absolute after:top-0 after:right-0' >
                  <div className='text-2xl xl:text-4xl font-extrabold text-accent mb-2  '>
                     <CountUp strat={0} end={250} duration={5} /> +
                  </div>
                ...
                <div className='relative flex-1 after:w-[1px] after:h-full after:bg-white/10 after:absolute after:top-0 after:right-0' >
                  <div className='text-2xl xl:text-4xl font-extrabold text-accent mb-2  '>
                     <CountUp strat={0} end={650} duration={5} /> +
                  </div>
                ...
                <div className='relative flex-1 ' >
                  <div className='text-2xl xl:text-4xl font-extrabold text-accent mb-2  '>
                     <CountUp strat={0} end={9} duration={5} /> +
                  </div>
          ...
          <div className=' py-2 xl:py-6 flex flex-col gap-y-2 xl:gap-y-4 items-center xl:items-start '>
            {aboutData[index].info.map((item, itemIndex)=>{
              return <div key={itemIndex} className='flex-1 flex flex-col md:flex-row max-w-max gap-x-2 items-center text-white/60' >
                    {/*title*/}
                    <div className='font-light mb-2 mmd:mb-0'>{item.title}</div>
